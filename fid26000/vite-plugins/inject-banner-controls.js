...
<style>
  ...
  body::before {
    ...
    font-weight: 500;
          ...
          // The shared controls live at /banners/_banner-support-files/, one
          // level above each banner's own /banners/<name>/ folder — so we
          // resolve up to the project root with an absolute URL.
          const controlsScript =
            '<script src="/banners/_banner-support-files/controls/_banners.js"></script>';
          html = html.replace(
