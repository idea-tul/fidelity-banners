...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    mainTl
      ...
      .addLabel("start")
      .to(".headline-1", { duration: 0.45, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=0.45")
      .to(".headline-2", { duration: 0.45, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=1.1")
      .to(".headline-3", { duration: 0.45, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=1.75")
      .to(".headline-4", { duration: 0.45, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=2.4")
      .to(".red-bar", { duration: 0.5, autoAlpha: 1, x: 0, ease: "power2.out" }, "start+=3.05")
      .to(".logo", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=3.05")
      .to(".fdic", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=3.05")
      .to(".nmls", { duration: 0.5, autoAlpha: 1, ease: "power2.out" }, "start+=3.05")
      .to(".cta", { duration: 0.55, autoAlpha: 1, scale: 1, ease: "power2.out" }, "start+=3.05");
