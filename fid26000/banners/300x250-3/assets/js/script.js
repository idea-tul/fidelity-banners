...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    mainTl
      ...
      .to(".headline-2", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=1.3")
      .to(".red-bar", { duration: 0.5, autoAlpha: 1, x: 0, ease: "power2.out" }, "start+=2.1")
      .to(".logo", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=2.1")
      .to(".fdic", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=2.1")
      .to(".nmls", { duration: 0.5, autoAlpha: 1, ease: "power2.out" }, "start+=2.1")
      .to(".cta", { duration: 0.55, autoAlpha: 1, scale: 1, ease: "power2.out" }, "start+=2.1");
