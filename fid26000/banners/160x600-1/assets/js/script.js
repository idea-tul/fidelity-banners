...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    mainTl
      ...
      .to(".headline-4", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=2.6")
      .to(".rbar", { duration: 0.5, autoAlpha: 1, x: 0, ease: "power2.out" }, "start+=3.4")
      .to(".logo", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=3.4")
      .to(".fdic", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=3.4")
      .to(".nmls", { duration: 0.5, autoAlpha: 1, ease: "power2.out" }, "start+=3.4")
      .to(".cta", { duration: 0.55, autoAlpha: 1, scale: 1, ease: "power2.out" }, "start+=3.4");
