...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    mainTl
      ...
      .to(".headline-2", { duration: 0.35, autoAlpha: 0, ease: "power2.in" }, "start+=1.45")
      .to(".headline-3", { duration: 0.4, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=1.6")
      .to(".headline-3", { duration: 0.35, autoAlpha: 0, ease: "power2.in" }, "start+=2.6")
      .to(".headline-1", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=3.4")
      .to(".logo", { duration: 0.6, y: 0, ease: "power2.out" }, "start+=3.4")
      .to(".cta", { duration: 0.55, autoAlpha: 1, ease: "power2.out" }, "start+=4.05");
