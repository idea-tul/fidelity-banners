...
var timeline = (function MasterTimeline() {
  ...
  function createTimeline() {
    ...
    mainTl
      ...
      .to(".headline-3", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=1.9")
      .to(".rbar", { duration: 0.5, autoAlpha: 1, x: 0, ease: "power2.out" }, "start+=2.7")
      .to(".divider", { duration: 0.5, autoAlpha: 1, scaleY: 1, ease: "power2.out" }, "start+=2.7")
      .to(".logo", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=2.7")
      .to(".fdic", { duration: 0.5, autoAlpha: 1, y: 0, ease: "power2.out" }, "start+=2.7")
      .to(".nmls", { duration: 0.5, autoAlpha: 1, ease: "power2.out" }, "start+=2.7")
      .to(".cta", { duration: 0.55, autoAlpha: 1, scale: 1, ease: "power2.out" }, "start+=2.7");
